...
const Review = () => {
  ...
  useEffect(() => {
    fetch("https://travellers-point-server-01.herokuapp.com/packages")
      .then((res) => res.json())
      .then((data) => {
  ...
  const onSubmit = (data) => {
    ...
    data.status = "Pending";
    fetch("https://travellers-point-server-01.herokuapp.com/orders", {
      method: "POST",
            ...
            <div className="package-box d-flex justify-content-center align-items-center">
              <div className="login-form">
                <form onSubmit={handleSubmit(onSubmit)}>
                  <input
                    defaultValue={singleReview?.packajeName}
                  ...
                  <br />
                  <input
                    defaultValue={singleReview?.price}

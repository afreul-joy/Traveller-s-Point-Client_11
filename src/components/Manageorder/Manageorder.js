...
const Manageorder = () => {
  ...
  useEffect(() => {
    fetch("https://travellers-point-server-01.herokuapp.com/manageAllOrder")
      .then((res) => res.json())
  ...
  const handleDelete = (id) => {
    ...
    if (proceed) {
      fetch(`https://travellers-point-server-01.herokuapp.com/orders/${id}`, {
        method: "DELETE",
  ...
  return (
    <div className="manage-container">
      <div className="my-5">
        <h1 className="text-danger m-5">
          Manage All Orders {allOrder?.length}
        </h1>
